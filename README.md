...
- 현재 릴리스: **v1.1** (Google Play 비공개 테스트, `versionCode 2`) — 릴리스 PRD [docs/prd/PRD_v1.1.md](./docs/prd/PRD_v1.1.md),
  변경 이력 [docs/changelog/CHANGELOG.md](./docs/changelog/CHANGELOG.md), 릴리스 절차 [docs/releases/RELEASE_v1.1.md](./docs/releases/RELEASE_v1.1.md)
